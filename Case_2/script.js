$(document).ready(function() {
	...
	function getTaiwanWeather(city_name) {
		...
		var Your_Weather_API_key = "CWB-1280CBFA-B1A8-4E14-9C2D-CC9DC6A3A6D9";  //IMPORTANT, replace it with your weather API Authkey 中央氣象局授權碼
		//中央氣象局 一般天氣預報-今明 36 小時天氣預報資料
